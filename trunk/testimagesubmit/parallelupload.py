...
class ParallelUploadHandler(webapp.RequestHandler):
    def get(self):
        self.response.out.write(template.render("parallelupload.html", 
...
class PostUploadHandler(webapp.RequestHandler):
    def post(self):
        ...
        self.response.out.write(template.render("parallelupload-done.html", data))


handlers = [('/parallelupload', ParallelUploadHandler),
            ('/parallelupload/deposit', DepositPictureHandler),
            ('/parallelupload/upload', PostUploadHandler)
           ]
